...
JOptionPane.showOptionDialog(null, "What do you want to do to make your pet happy?", "Choose an option", JOptionPane.QUESTION_MESSAGE, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);               
